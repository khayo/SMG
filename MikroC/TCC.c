...
void emergencia(){
       ...
       Glcd_Image(EMER);
         ...
         if(BTN_EMERGENCIA == 1 && emerg == 1){
           emerg = 0;
           UART1_write_text("Solte o botao de emergencia para resetar");
       ...
       UART1_Write(10);
       UART1_Write(13);
       UART1_write_text("Pronto para operar");
       UART1_write(13);
       UART1_write(10);
       Glcd_Fill(0);
       carregar_tela = 1;
...
void serial_menu(){
     ...
     //UART1_Write(uart_rd); //habilita eco
         ...
         if(uart_rd == 'x'){
            UART1_Write(12);
            UART1_write_text("Carga Desligada");
            UART1_Write(10);
            UART1_Write(13);
            UART1_Write(13);

            desliga_carga();
            serial_transferencia();
         }
         if(uart_rd == 'z'){
            UART1_Write(12);
            UART1_write_text("Rede Ligada");
            UART1_Write(10);
            UART1_Write(13);
            UART1_Write(13);
         ...
         if(uart_rd == 'c'){
            UART1_Write(12);
            UART1_write_text("Gerador Ligado");
            UART1_Write(10);
            UART1_Write(13);
            UART1_Write(13);
         ...
         if(uart_rd == 'a'){
            UART1_Write(12);
            UART1_write_text("EQUIPAMENTO EM MODO EMERGENCIA");
            UART1_Write(10);
            UART1_Write(13);
            UART1_write_text("Para resetar, pressione o botao de emergencia local");
            UART1_Write(10);
            UART1_Write(13);
            UART1_write_text("e siga as intrucoes do terminal");
            UART1_Write(10);
            UART1_Write(13);
            emerg = 1;
            UART1_Write(emerg);
...
void serial_principal(){
        UART1_Write(12);
        UART1_Write_Text("w - Menu Transferencia");
        UART1_Write(10);
        UART1_Write(13);
        UART1_Write_Text("e - Menu Emergencia");
        UART1_Write(10);
        UART1_Write(13);
        UART1_Write_Text("r - Tensao Bateria");
        UART1_Write(10);
        UART1_Write(13);
...
void serial_emergencia(){
        UART1_Write(12);
        UART1_Write_Text("a - Ativa Emergencia");
        UART1_Write(10);
        UART1_Write(13);
        UART1_Write_Text("s - Desativar Emergencia (Somente Info)");
        UART1_Write(10);
        UART1_Write(13);
        UART1_Write_Text("H - Voltar");
        UART1_Write(10);
        UART1_Write(13);
}
...
void serial_transferencia(){
        switch(carga){
          case 0:
               ...
               break;
          case 1:
               UART1_Write_Text("Rede em carga");
               UART1_Write(10);
               UART1_Write(13);
               break;
          case 2:
               UART1_Write_Text("GMG em carga");
               UART1_Write(10);
               UART1_Write(13);
               break;
          }
        UART1_Write_Text("z - Liga Rede");
        UART1_Write(10);
        UART1_Write(13);
        UART1_Write_Text("x - Desliga carga");
        UART1_Write(10);
        UART1_Write(13);
        UART1_Write_Text("c - Liga Gerador");
        UART1_Write(10);
        UART1_Write(13);
...
//não apagar esta função pois pode ser necessária para adicionar novos botões
/*void calibra_botoes(){
botao = adc_read(1);
delay_ms(50);
if(botao != ultimo_botao){
       Glcd_Box(5, 20, 60, 40, 0);
       ultimo_botao = botao;
     }
 //usado para testar botões
if (botao >= 80 && botao <= 100){
      Glcd_Write_Text_Adv("rede", 5, 30);
  }
  if (botao >= 170 && botao <= 190){
  ...
  if (botao >= 590 && botao <= 610){
      Glcd_Write_Text_Adv("reserva 1", 5, 30);
  }
  if (botao >= 690 && botao <= 710){
      Glcd_Write_Text_Adv("reserva 2", 5, 30);
  }

  //mostra o valor de adc
  intToStr(botao, txt_botao);
  ltrim(txt_botao);
  Glcd_Write_Text_Adv(txt_botao, 40, 20);
  Glcd_Write_Text_Adv("botao:", 5, 20);
}*/
